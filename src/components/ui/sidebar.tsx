...
function SidebarMenuButton({
  ...
  // Use span when asChild is true OR when tooltip is provided
  // to avoid nested button issues
  const shouldUseSpan = asChild || tooltip
  const defaultTag = shouldUseSpan ? "span" : "button"
  ...
  // If no tooltip, return the base element
  if (!tooltip) {
    return baseElement
  }

  // With tooltip: wrap with Tooltip
